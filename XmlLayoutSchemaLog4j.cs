...
namespace log4net.Layout
{
	...
	{
		// Token: 0x0600933B RID: 37691 RVA: 0x00057FDC File Offset: 0x000561DC
		public XmlLayoutSchemaLog4j()
		{
		}

		// Token: 0x0600933C RID: 37692 RVA: 0x00057FE4 File Offset: 0x000561E4
		...
		// (get) Token: 0x0600933D RID: 37693 RVA: 0x00057FED File Offset: 0x000561ED
		// (set) Token: 0x0600933E RID: 37694 RVA: 0x00057FF4 File Offset: 0x000561F4
		...
		// Token: 0x0600933F RID: 37695 RVA: 0x001418A4 File Offset: 0x0013FAA4
		protected override void FormatXml(XmlWriter writer, LoggingEvent loggingEvent)
		{
			...
			if (text != null && text.Length > 0 && loggingEvent.LookupProperty("log4net:Identity") == null)
			{
				loggingEvent.GetProperties()["log4net:Identity"] = loggingEvent.Identity;
			}
			text = loggingEvent.UserName;
			if (text != null && text.Length > 0 && loggingEvent.LookupProperty("log4net:UserName") == null)
			{
			...
			if (obj != null)
			{
				string text2 = loggingEvent.Repository.RendererMap.FindAndRender(obj);
			...
			if (properties.Count > 0)
			{
				...
				foreach (object obj2 in ((IEnumerable)properties))
				{
					...
					string text3 = loggingEvent.Repository.RendererMap.FindAndRender(dictionaryEntry.Value);
